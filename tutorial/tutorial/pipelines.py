...
class TutorialPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        # 获取当前联赛名称
        current_league = spider.start_urls[0].split(',' )[-1].replace('-','_')
        ...
        try:
            with connection.cursor() as cursor:
                ...
                build_table = (
                    ...
                    "handicap_name VARCHAR(20),"
                    "handicap_host_win_back_price1 FLOAT,"
                    "handicap_host_win_back_price1_amount FLOAT,"
                    "handicap_host_win_back_price2 FLOAT,"
                    "handicap_host_win_back_price2_amount FLOAT,"
                    "handicap_host_win_back_price3 FLOAT,"
                    "handicap_host_win_back_price3_amount FLOAT,"
                    "handicap_host_win_lay_price1 FLOAT,"
                    "handicap_host_win_lay_price1_amount FLOAT,"
                    "handicap_host_win_lay_price2 FLOAT,"
                    "handicap_host_win_lay_price2_amount FLOAT,"
                    "handicap_host_win_lay_price3 FLOAT,"
                    "handicap_host_win_lay_price3_amount FLOAT,"
                    "handicap_guest_win_back_price1 FLOAT,"
                    "handicap_guest_win_back_price1_amount FLOAT,"
                    "handicap_guest_win_back_price2 FLOAT,"
                    "handicap_guest_win_back_price2_amount FLOAT,"
                    "handicap_guest_win_back_price3 FLOAT,"
                    "handicap_guest_win_back_price3_amount FLOAT,"
                    "handicap_guest_win_lay_price1 FLOAT,"
                    "handicap_guest_win_lay_price1_amount FLOAT,"
                    "handicap_guest_win_lay_price2 FLOAT,"
                    "handicap_guest_win_lay_price2_amount FLOAT,"
                    "handicap_guest_win_lay_price3 FLOAT,"
                    "handicap_guest_win_lay_price3_amount FLOAT,"
